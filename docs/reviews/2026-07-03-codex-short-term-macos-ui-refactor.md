...
- Short-term optimization proof: pass; `.artifacts/product/short-term/short-term-optimization-proof.json` records two safe actions, 302 B -> 242 B output size, unchanged source SHA, changed optimized SHA, visible metrics, visible before/after comparison, and enabled Save As.
