...
- Context: real avatar-frame samples can contain a single near-empty final
  sequence PNG after a run of ordered non-overlapping frames.
- Problem: rejecting every boundary candidate leaves a real flicker class
