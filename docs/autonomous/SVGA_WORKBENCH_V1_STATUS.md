...
proof. The player-level canvas hash did not change for the four-pixel speck
frames; this is recorded for Product Owner review and does not re-enable manual
visual confirmation as a blocker.
