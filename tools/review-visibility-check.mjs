...
const posixPathSegmentPattern = String.raw`[^${slash}\s"'` + "`" + String.raw`]+`;
const posixLocalPathTextPattern = String.raw`(?:${slash}${"Users"}${slash}${posixPathSegmentPattern}(?:${slash}[^\s"'` + "`" + String.raw`]*)?|${slash}private${slash}${posixPathSegmentPattern}(?:${slash}[^\s"'` + "`" + String.raw`]*)?|${slash}var${slash}folders${slash}${posixPathSegmentPattern}(?:${slash}[^\s"'` + "`" + String.raw`]*)?|${slash}tmp${slash}${posixPathSegmentPattern}(?:${slash}[^\s"'` + "`" + String.raw`]*)?)`;
const localPathTextPattern = String.raw`(?:${posixLocalPathTextPattern}|${windowsDrivePathTextPattern}|${uncPathTextPattern})`;
