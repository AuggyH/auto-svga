export function collectShortTermNodes() {
  return {
    ...
    failureView: document.querySelector("[data-view='failed']"),
    failureStage: document.querySelector("#failureStage"),
    failureTitle: document.querySelector("#failureTitle"),
    errorMessage: document.querySelector("#errorMessage"),
    failurePanel: document.querySelector("#failurePanel"),
    failurePanelTitle: document.querySelector("#failurePanelTitle"),
    failurePanelMessage: document.querySelector("#failurePanelMessage"),
