...
test("main process keeps sandboxed Electron security settings", async () => {
  ...
  assert.match(main, /Save Replacement As\.\.\./);
  assert.match(main, /Undo Replacement Preview/);
  assert.match(main, /Redo Replacement Preview/);
  assert.match(main, /Reset Replacement Preview/);
