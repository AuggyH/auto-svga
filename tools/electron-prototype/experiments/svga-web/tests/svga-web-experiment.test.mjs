...
test("default Electron renderer is the short-term macOS client and keeps legacy Workbench isolated", async () => {
  ...
  assert.match(shortTermEntry, /from "\.\/short-term-macos-resource-menu-renderers\.mjs"/);
  ...
  assert.match(shortTermEntry, /renderFailureMessage/);
  ...
  assert.doesNotMatch(shortTermDomRenderers, /export function createOverviewFactCell|export function createAssetRow|export function renderOverviewFacts|export function renderAssetList|renderOverviewFactCellHtml/);
  ...
  assert.doesNotMatch(shortTermDomRenderers, /export function createOptimizationFindingRow|export function renderOptimizationFindings|export function prependOptimizationResult|export function createMessageRow|renderOptimizationFindingHtml|renderMessageRowHtml/);
  ...
  assert.doesNotMatch(shortTermDomRenderers, /from "\.\/short-term-macos-inline-status-renderers\.mjs"/);
  ...
  assert.doesNotMatch(shortTermDomRenderers, /export function renderLoadingMessage|export function renderFileHeader|export function renderDiscardMessage|export function renderFailureMessage/);
  ...
  assert.doesNotMatch(shortTermDomRenderers, /export function showResourceContextMenu|export function hideResourceContextMenu/);
  ...
  assert.doesNotMatch(shortTermDomRenderers, /export function applyRuntimeTextOverlay|export function clearRuntimeTextOverlay/);
  ...
  assert.doesNotMatch(shortTermDomRenderers, /export function createReplaceableImageRow|export function renderReplaceableImages|export function createTextElementRow|export function renderRuntimeTextElements|ReplaceableImageRow|ReplaceableTextRow/);
  ...
  assert.doesNotMatch(shortTermDomRenderers, /function renderThumbnailHtml|isSafeImageDataUrl/);
  assert.match(shortTermDomRenderers, /from "\.\/short-term-macos-thumbnail-renderers\.mjs"/);
  ...
  assert.match(shortTermEntry, /from "\.\/short-term-macos-optimization-renderers\.mjs"/);
  ...
  assert.match(shortTermEntry, /collectShortTermOpenFlowProof/);
  ...
  assert.match(shortTermEntry, /collectShortTermLoadFailureProof/);
  ...
  assert.match(shortTermEntry, /collectShortTermRuntimeTextBoundaryProof/);
